...
<body style="background-color: #efebe9">
	...
	<nav class="#ef5350 red lighten-1" role="navigation">
		...
		<div class="nav-wrapper container">
			<a id="logo-container" href="Profile.php" class="brand-logo">Top
				Matches</a>
	...
	<ul class="collection">
		<a href="comentario.php">
			<li style="background-color: #FFF" class="collection-item avatar"><img
				...
				<p style="color: black">
					Macarrão com molho branco & Vinho Chardonnay<br>
