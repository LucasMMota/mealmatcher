...
<div style="z-index: 0;" class="slider">
    ...
    <p>O restaurante Casa no Campo é um restaurante de requinte e de ambiente muito agradável, com serviço de qualidade oferece a mais aliciante e variada seleção da cozinha típica paulistana.
        ...
        O ponto vem sendo passado através das gerações, sempre mantendo a cozinha tradicional paulista. Com o crescimento no número de frequentadores do estabelecimento, surgiu a necessidade de verificar os níveis de satisfação dos clientes e a aprovação do cardápio e sugestões de refeições. Com esta finalidade, foi pensado o aplicativo Meal Matcher, que permitirá aos clientes avaliar e recomendar sua experiência no estabelecimento.</p>
</div>
</body>
{$footer}