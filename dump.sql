...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Jun-2016 às 05:42
...
CREATE TABLE IF NOT EXISTS `cad_avaliacao` (
  ...
  `ava_data` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `cad_sugestao` (
  ...
  `sug_data_insert` datetime DEFAULT CURRENT_TIMESTAMP,
  `sug_data_update` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `pes_id` int(11) NOT NULL,
  PRIMARY KEY (`sug_id`),
